package com.example.contactosjetpackconpounds
...
import com.example.contactosjetpackconpounds.ui.theme.ContactosJetPAckConpoundsTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            ContactosJetPAckConpoundsTheme {
