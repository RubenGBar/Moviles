...
@Composable
fun pantalla1(navController: NavHostController, usuario: String?) {
            ...
            Button(
                ...
                onClick = {
                    ...
                    if(ganador.equals("PC") || ganador.equals("Jugador")){
                        Toast.makeText(contexto,"Ha ganado $usuario", Toast.LENGTH_LONG).show()
                    }else {
                        Toast.makeText(contexto,"Ha ganado el PC", Toast.LENGTH_LONG).show()
                    }
                    ...
                    if(puntJu >= 3){
                        navController.navigate("PantallaGanador/${usuario}/${ganador}")
                    }else if(puntPc >= 3){
                        navController.navigate("PantallaGanador/${usuario}/${ganador}")
                    }
                },
